...
const headCells = [
  ...
  { id: "trace", numeric: false, disablePadding: true, label: "trace" },
...
export default function EnhancedTable({ rows, onChange }) {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        {convertTruncateText(row.message, 15)}
                      </TableCell>
                      <TableCell align="right">
                        {convertTruncateText(row.trace, 15)}
                      </TableCell>
                      <TableCell align="right">
                        <CheckBox
                          onChange={onChange}
